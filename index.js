const  XBOT = 'Alpin'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/Alpinbot'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+629690719275'; // Nomor whatsapplu cok
const aktif = 'Tergantung kuota'; // Kapan bot lu aktif
const groupwa = 'comming soon'; // OFFICIAL GRUP LU 1
const youtube = 'https://youtube.com/channel/UCPfM-qelpkAnDwBPF00k_XQ'; 
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6289690719275:+62 896-9071-9275\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
conn.sendMessage(id, 'Owner XBOT wa.me/+6289690719275' ,MessageType.text);
}
else if (text == 'Alpin'){
conn.sendMessage(id, 'Aku BOT nya Alpin' ,MessageType.text);
}
else if (text == 'audio'){
...
conn.sendMessage(id, ' 🔍Thanks Telah Menggunakan BOT *Tsubasa* , terimah kasi telah menggunakan bot Alpin💪� : gunakan dengan bijak yak by Alpin' ,MessageType.text);
}
else if (text == '#info'){
conn.sendMessage(id, ' 🔍Thanks Telah Menggunakan BOT *Tsubasa* , terimakasih telah menggunakan bot alpin💪� : gunalan dengan bijak yak by Alpin' ,MessageType.text);
}
